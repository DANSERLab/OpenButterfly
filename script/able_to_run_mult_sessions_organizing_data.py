...
session_list = ['Session5', 'Session6', 'Session9', 'Session10', 'Session11', 'Session12', 'Session7']
...
for a in range(len(session_list)):
	...
	# everythin above goes in the variable block

	session = session_list[a]
	print('========================================================================')
	print('========================================================================')
	print('This sessin is ', session)
